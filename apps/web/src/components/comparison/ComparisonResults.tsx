 ...
 *
 * Displays comparison statistics and delta analysis results with tabbed interface.
 */
  ...
  return (
    <Card>
      <CardContent>
        ...
        {/* Tabs for Data Table and Statistical Summary */}
        <Paper sx={{ mb: 3 }}>
          <Tabs
            value={dataTab}
          ...
          <Box sx={{ p: 3 }}>
            {/* Tab 0: Comparison Result Data Table */}
            {dataTab === 0 && (
              <Box>
